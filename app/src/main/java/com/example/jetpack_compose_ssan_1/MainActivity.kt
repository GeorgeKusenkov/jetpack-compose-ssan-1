                ...
                Column(
                    ...
                    if(result.isNotEmpty()) {
                        for (person in result) {
                            Text(text = person.name, fontSize = MaterialTheme.typography.bodyLarge.fontSize)
                        }
                    } else {
                        Text(text = "Empty Database", fontSize = MaterialTheme.typography.bodyLarge.fontSize)
                    }
                }
            }
        }
