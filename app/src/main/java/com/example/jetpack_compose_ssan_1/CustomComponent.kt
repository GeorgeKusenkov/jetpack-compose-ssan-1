...
fun CustomComponent(
    ...
    allowedIndicatorValue = if (indicatorValue <= maxIndicatorValue) {
        Log.d("check111","indicatorValue <= maxIndicatorValue: ${indicatorValue <= maxIndicatorValue}")
        Log.d("check111","maxIndicatorValue: $maxIndicatorValue")
        Log.d("check111","indicatorValue: $indicatorValue")
    ...
    Log.d("check111","allowedIndicatorValue: $allowedIndicatorValue")
    ...
    indicatorStrokeWidth: Float
        ...
        drawArc(
            ...
            topLeft = Offset(
                ...
                y = (size.height - componentsSize.width) /2f
            )
        )
}
